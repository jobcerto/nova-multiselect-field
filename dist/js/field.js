...
Nova.booting(function (Vue, router) {
    Vue.component('index-multiselect', __webpack_require__(3));
    Vue.component('detail-multiselect', __webpack_require__(6));
    Vue.component('form-multiselect', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c(
    "span",
    _vm._l(_vm.field.value, function(option) {
      return _c(
        "span",
        { staticClass: "p-1 inline-block" },
        [
        ...
        [
          _c(
            "el-select",
            {
              ...
              attrs: { placeholder: _vm.field.name, multiple: "" },
              model: {
                value: _vm.value,
                callback: function($$v) {
                  _vm.value = $$v
